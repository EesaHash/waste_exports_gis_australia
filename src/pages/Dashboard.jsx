  ...
  return data.filter((feature) => {
    return (
      (filters.years.includes("All") ||
        filters.years.includes(feature.origin.year)) &&
      (filters.quarters.includes("All") ||
        filters.quarters.includes(feature.origin.quarter)) &&
      (filters.materialGroups.includes("All") ||
        filters.materialGroups.includes(feature.MaterialGroup)) &&
      (filters.destinations.includes("All") ||
        filters.destinations.includes(feature.destination.name))
    );
  });
}
...
export default function Dashboard() {
  ...
  return (
    <div className="w-[150vw] h-[130vh] bg-emerald-950 p-5">
      <h1 className="text-white font-bold text-xl font-mono mt-1 mb-5">
          ...
          <div key={label} className="flex flex-col space-y-2">
            ...
            <div className="flex flex-row space-y-2">
              <div className="text-white text-xs w-[170px]">
                ...
                <div className="overflow-x-auto text-xs overflow-y-hidden content-center border border-emerald-900 rounded scrollbar-thin scrollbar-thumb-emerald-500 scrollbar-track-emerald-700 h-8">
              ...
              >
                <FaFilterCircleXmark className="text-red-600 hover:text-red-400 transition text-xl" />
              </button>
            </div>
          </div>
        ))}
